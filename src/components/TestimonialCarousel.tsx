  ...
  return (
    <section className="py-32 px-6 relative z-10 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        >
          <span className="label-micro text-gold-warm">Reserve Your Date</span>
          <h2 className="display text-3xl md:text-5xl text-cream leading-tight max-w-2xl">
            Your guests deserve a drink <em className="text-gold-warm italic">worth remembering.</em>
          </h2>
          <p className="text-cream text-base md:text-lg max-w-xl mx-auto leading-relaxed font-medium">
            Tell us about your event and we'll put together a personalised proposal — drinks menu, setup, and pricing — within 24 hours.
          </p>
          <a
